...
class Task:
    ...
    def start(self):
        ...
        self.home = Home(100, 200,32,32,IMG_HOME)
        stage.add_object(self.home)
        self.boulders = [
            Boulder(100,0,100,IMG_BOULDER),
            Boulder(0,100,100,IMG_BOULDER),
            Boulder(-100,0,100,IMG_BOULDER),
            Boulder(0,-100,100,IMG_BOULDER),
            Boulder(100, 100,50,IMG_BOULDER),
            Boulder(-100, 200,50,IMG_BOULDER),
            Boulder(0, 200,50,IMG_BOULDER),
        ]
